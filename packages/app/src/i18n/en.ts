export const dict = {
  ...
  "settings.general.section.customResponse": "Custom Response",
  "settings.general.row.customResponse.title": "Personalize your AI experience",
  "settings.general.row.customResponse.description": "Customize how the AI responds to you",
  "settings.general.row.customResponse.name.title": "Your name",
  "settings.general.row.customResponse.name.description": "This name will be used to personalize responses",
  "settings.general.row.customResponse.tone.title": "AI tone",
  "settings.general.row.customResponse.tone.description": "Choose how the AI communicates with you",
  "settings.general.row.customResponse.tone.option.neutral": "Neutral",
  "settings.general.row.customResponse.tone.option.friendly": "Friendly",
  "settings.general.row.customResponse.tone.option.professional": "Professional",
  "settings.general.row.customResponse.tone.option.casual": "Casual",
  "settings.general.row.customResponse.tone.option.encouraging": "Encouraging",
  "settings.general.row.customResponse.tone.option.concise": "Concise",
  "settings.general.row.customResponse.customInstructions.title": "Custom instructions",
  "settings.general.row.customResponse.customInstructions.description": "Add specific instructions for how the AI should behave",
