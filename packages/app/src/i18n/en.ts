export const dict = {
  ...
  "settings.tab.customResponse": "Custom Response",
  ...
  "settings.customResponse.title": "Custom Response",
  "settings.customResponse.description": "Personalize your AI experience",
  "settings.customResponse.name.title": "Your name",
  "settings.customResponse.name.description": "This name will be used to personalize responses",
  "settings.customResponse.tone.title": "AI tone",
  "settings.customResponse.tone.description": "Choose how the AI communicates with you",
  "settings.customResponse.tone.option.neutral": "Neutral",
  "settings.customResponse.tone.option.friendly": "Friendly",
  "settings.customResponse.tone.option.professional": "Professional",
  "settings.customResponse.tone.option.casual": "Casual",
  "settings.customResponse.tone.option.encouraging": "Encouraging",
